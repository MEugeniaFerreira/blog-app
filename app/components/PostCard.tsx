...
const PostCard = ({ post }: { post: PostType }) => {
	return (
      ...
      <div className='relative overflow-hidden shadow-md mb-6'>
				<Image src={post.featuredImage.url} alt={post.title} width={800} height={320} className='object-top h-80 w-full rounded-t-lg shadow-md object-cover' unoptimized />
			</div>

			<h1 className='transition duration-700 text-center text-3xl font-semibold cursor-pointer hover:text-pink-600'>
